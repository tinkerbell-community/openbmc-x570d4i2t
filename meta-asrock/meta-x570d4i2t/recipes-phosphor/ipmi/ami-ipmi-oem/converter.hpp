...
//
// The converter is the single source of truth for these layouts so the blob
// handler, legacy 0xB5 push path, and MDR V2 0x52 write path all agree on
// where the AMI 4-byte prefix lives and how the on-disk MDR header is built.
